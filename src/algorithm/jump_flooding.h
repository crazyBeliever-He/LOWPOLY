#ifndef JUMP_FLOODING_H
#define JUMP_FLOODING_H
...
public:
    ...
    // CUDA版本JFA, TODO: 实现JFA的变体如JFA+1等，使其正确率更高
    ...
    bool jumpFloodingCPU(const ScopedEDResults& edResults,
                         int imgWidth,
                         int imgHeight);
    QImage drawJFAMap(int width, int height, const std::vector<JFAFF::JFAPoint>& jfaOutput, const ScopedEDResults& edResults);
